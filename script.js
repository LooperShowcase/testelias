...
// GPT's response is stored in this variable
let open_ai_response;

// This is the conversation history array, it has JSON objects inside
let conversation = [
  { role: "user", content: "Hi" },
  { role: "assistant", content: "Hi, how can I help you today" },
];

// This function appends a user input into the conversation history
async function conversationUserAdd(question, sentiment) {
  conversation.push({ role: "user", content: question });
  updateChatContainer(); // we will build this function later on, it's purpose is to show the chat history
}

// This function appends a GPT output into the conversation history
...
async function openai_test() {
  ...
  var apikey1 = "sk-91mgOd";
  var apikey2 = "IikleCpgTQ6vOZT3BlbkFJKc";
  var apikey3 = "7gkeoVwAVaSIYQwVXk";
